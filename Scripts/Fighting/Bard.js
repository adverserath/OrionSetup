function Provoke() {
    var bardRange = 8 + ((parseInt(Orion.SkillValue('Provocation')) / 10) / 15);
...
function ProvokeClose() {
    var bardRange = 8 + parseInt((parseInt(Orion.SkillValue('Provocation')) / 10) / 15);
...
function discord()
{
    ...
    var bardRange = 8 + parseInt((parseInt(Orion.SkillValue('Discordance')) / 10) / 15);
    Orion.Print(bardRange)
    var mobs = []
